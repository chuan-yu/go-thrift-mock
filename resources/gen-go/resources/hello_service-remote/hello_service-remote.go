...
var _ = resources.GoUnusedProtection__

func Usage() {
  fmt.Fprintln(os.Stderr, "Usage of ", os.Args[0], " [-h host:port] [-u url] [-f[ramed]] function [arg1 [arg2...]]:")
  flag.PrintDefaults()
  fmt.Fprintln(os.Stderr, "\nFunctions:")
  fmt.Fprintln(os.Stderr, "  Response sayHello(Request request)")
  fmt.Fprintln(os.Stderr)
  os.Exit(0)
}
...
func main() {
  ...
  client := resources.NewHelloServiceClient(thrift.NewTStandardClient(iprot, oprot))
  ...
  case "sayHello":
    ...
    argvalue0 := resources.NewRequest()
